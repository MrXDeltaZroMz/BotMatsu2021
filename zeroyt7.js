...
⬣ Nama Bot : Matsu Botz
⬣ Nama Owner : Mr.XDeltaZroMz
⬣ No Owner : 6281285181896
⬣ Creator : Mr.XDeltaZroMz
⬣ Prefix : Multi
...
costum(buffer, sticker, Verived, `© Mr.XDeltaZroMz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `© Mr.XDeltaZroMz`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
❏ Runtime = ${runtime(process.uptime())}
❏ Nama Bot = ${botname}
❏ Youtube = https://youtube.com/channel/UC3PbGj85KYkwoge-bUJXGtQ
❏ Creator Bot = Mr.XDeltaZroMz`
but = [
...
*════〘 Ndyie 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Mr.XDeltaZroMz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./ndyie.jpg'),sourceUrl:"OV1876"}}})
break
case 'hai':
...
break
case 'pribadi':
zeroyt7.sendMessage(from, `*[❗] Ndyie Gamteng*
Dukung trus Ndyie
...
*════〘 Ndyie 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "By Mr.XDeltaZroMz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./ndyie.jpg'),sourceUrl:"OV1876"}}})
break
case 'buysc':
reply ('Mau Beli Sc Bro\nhttps://wa.me/p/4496989643700781/62895622598104\nKlik Itu Kalo Mau Beli')
break
case 'bagi':
reply ('*Skuy Nonton Baru Upload Ni*\n\n```https://youtu.be/xlB2Y-h7p3w```\n\n*No Enc + No Pw*')
break
case 'halu':
reply ('Halu? Emang Lu Mikirin Siapa Anjing')
break
